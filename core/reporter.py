...
def _generate_cost_optimization(assessment_data):
    ...
    if not findings:
        ...
        <div style="padding:32px;text-align:center;background:#f8fafc;border-radius:8px;
            ...
            <p style="color:#64748b;">✅ Tidak ditemukan waste yang jelas dari 4 rule yang dievaluasi.</p>
        </div>'''
    ...
    for cat, data in summary.items():
        ...
        <div class="stat-item">
            ...
            <div style="font-size:0.8em;color:#ef4444;margin-top:2px;">
                ~${data['savings']:.2f}/bln
            </div>
        </div>'''
    ...
    for f in findings:
        ...
        <tr>
            ...
            <td style="color:#ef4444;font-weight:600;white-space:nowrap">
                ~${f['estimated_monthly_cost']:.2f}/bln
            </td>
        </tr>'''
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Resource</th>
                        <th>Detail</th>
                        <th>Est. Cost/Bulan</th>
                    </tr>
                </thead>
                <tbody>{rows_html}</tbody>
            </table>
        </div>
        <p style="margin-top:12px;font-size:0.8em;color:#94a3b8">
            ⚠ {note}
        </p>
    </div>'''
...
def generate_html_report(assessment_data, customer_name, account_id, region):
    ...
    cost_opt_html = _generate_cost_optimization(assessment_data)
    template = template.replace('{{COST_OPTIMIZATION}}', cost_opt_html)
